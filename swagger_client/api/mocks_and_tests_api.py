...
class MocksAndTestsApi(object):
    ...
    def check_categorization(self, body, **kwargs):  # noqa: E501
        """Check categorization  # noqa: E501

        This service can be used to check the categorization for a given set of transactions, without the need of having the transactions actually imported in finAPI. The result of the categorization is the same as if the transactions were actually imported (the service regards the user-specific categorization rules of the user that is authorized by the access_token). Must pass the user's access_token.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.check_categorization(body, async=True)
        >>> result = thread.get()

        :param async bool
        :param TransactionsData body: Transactions data (required)
        ...
        if kwargs.get('async'):
            return self.check_categorization_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.check_categorization_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def check_categorization_with_http_info(self, body, **kwargs):  # noqa: E501
        """Check categorization  # noqa: E501

        This service can be used to check the categorization for a given set of transactions, without the need of having the transactions actually imported in finAPI. The result of the categorization is the same as if the transactions were actually imported (the service regards the user-specific categorization rules of the user that is authorized by the access_token). Must pass the user's access_token.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.check_categorization_with_http_info(body, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method check_categorization" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `check_categorization`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='CategorizationCheckResults',  # noqa: E501
