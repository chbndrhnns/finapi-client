...
------------ | ------------- | ------------- | -------------
**id** | **str** | User&#39;s identifier. Max length is 36 symbols. Only the following symbols are allowed: 0-9, A-Z, a-z, -, _, ., +, @. If not specified, then a unique random value will be generated. | [optional] 
**password** | **str** | User&#39;s password. Minimum length is 6, and maximum length is 36. If not specified, then a unique random value will be generated. | [optional] 
**email** | **str** | User&#39;s email address. Maximum length is 320. | [optional] 
**phone** | **str** | User&#39;s phone number. Maximum length is 50. | [optional] 
